...
pub fn style_for(element: ThemeElement) -> Style {
    match element {
        ...
        ThemeElement::Primary => Style::new().fg(primary()),
        ThemeElement::Secondary => Style::new().fg(secondary()).add_modifier(Modifier::BOLD),
        ThemeElement::Hazard => Style::new().fg(hazard()),
        ThemeElement::Accent => Style::new().fg(accent()),
...
mod tests {
    ...
    fn style_for_returns_non_default_for_all_elements() {
        ...
        let elements = [
            ...
            ThemeElement::Text,
            ThemeElement::Dim,
            ThemeElement::Primary,
            ThemeElement::Secondary,
            ThemeElement::Hazard,
            ThemeElement::Accent,
            ThemeElement::Border,
